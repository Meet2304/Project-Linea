 ...
 *
 * The app inlines these too rather than depending on the package (see
...
interface Props {
  ...
  strokeWidth?: number
  className?: string
  /** `play` and `pause` read better filled. */
  filled?: boolean
}

export default function Icon({ name, size = 18, strokeWidth = 1.75, className, filled }: Props) {
  return (
    <svg
