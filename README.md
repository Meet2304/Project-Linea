...
- **Personalizable** — pin on top and close from the top bar; three lyric-size presets (with a live preview), optional lyric timestamps, and show/hide lyrics in settings
